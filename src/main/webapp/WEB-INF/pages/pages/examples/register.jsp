  ...
  <body class="hold-transition register-page">
    <div class="register-box">
      ...
      <div class="register-box-body">
        ...
        <form:form id="form" action="addregistereduser" modelAttribute="userobj">
          ...
          <div class="form-group has-feedback">
            <form:input type="text" path ="mobile" id="mobile" class="form-control" placeholder="Mobile"/>
        ...
        <a href="${pageContext.request.contextPath}/pages" class="text-center">I already have a membership</a>
      </div><!-- /.form-box -->
    </div><!-- /.register-box -->
