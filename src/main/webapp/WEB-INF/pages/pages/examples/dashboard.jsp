...
<html>
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/pages/dist/css/skins/_all-skins.min.css">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="${pageContext.request.contextPath}" class="">LOGOUT</a>
              </li>
            </ul>
          </div>
        </nav>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="${pageContext.request.contextPath}/pages/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
            </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="${pageContext.request.contextPath}/users"><i class="fa fa-user"></i> <span>Users</span></a></li>
            ...
            <li><a href="${pageContext.request.contextPath}"><i class="fa fa-power-off"></i> <span>Logout</span></a></li>
          </ul>
        </section>
        <!-- /.sidebar -->
      </aside>
          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                ...
                <a href="${pageContext.request.contextPath}/pages/pages/pdf/selenium-testing-syllabus-jbk.pdf" class="small-box-footer" target="_blank">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-green">
                ...
                <a href="${pageContext.request.contextPath}/pages/pages/pdf/java-j2ee-syllabus-jbk.pdf" class="small-box-footer" target="_blank">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-yellow">
                ...
                <a href="${pageContext.request.contextPath}/pages/pages/pdf/python-syllabus.pdf" class="small-box-footer" target="_blank">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
    ...
    <!-- FastClick -->
    <script src="${pageContext.request.contextPath}/pages/plugins/fastclick/fastclick.min.js"></script>
    <!-- AdminLTE App -->
    <script src="${pageContext.request.contextPath}/pages/dist/js/app.min.js"></script>
